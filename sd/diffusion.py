...
class UNET_ResidualBlock(nn.Module):
    ...
    def forward(self, feature, time):
        # feature: (Batch_Size, Features, Heights, Width)
        # time: (1, 1280)
...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x, context):
        ...
        # Normalization + Self Sttention with skip connection
...
class UpSample(nn.Module):
    ...
    def forward(self, x):
        # (Batch_Size, Features, Heights, Width) -> (Batch_Size, Features, Height*2, Width*2)
...
class Diffusion(nn.Module):
    ...
    def forward(self, latent: torch.Tensor, context: torch.Tensor, time: torch.Tensor):
        ...
        # (Batch,4, Height/8, Width/8) -> (Batch, 320, Height/8)
        output = self.unet(latent, context, time)
        
        # (Batch, 320, Height/8) -> (Batch,4, Height/8, Width/8)
